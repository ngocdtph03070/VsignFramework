#
#  Be sure to run `pod spec lint VsignFramework.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.version      = "1.0.0"
  spec.summary      = "A short description of VsignFramework."

  spec.description  = "This is framework Vsign"
